...
/**
 * description: 生成service类和controller类
...
public class MybatisPlusServicePlugin extends PluginAdapter {
    ...
    private GeneratedJavaFile getControllerJava(IntrospectedTable introspectedTable, String basePackage, String modelName, String targetProject,
        ...
        addMethod.addBodyLine(MessageFormat.format(addMethodBodyLine, modelFieldName));
        ...
        delMethod.addBodyLine(MessageFormat.format(delMethodBodyLine, modelFieldName));
        ...
        updateMethod.addBodyLine(MessageFormat.format(updateMethodBodyLine, modelFieldName));
